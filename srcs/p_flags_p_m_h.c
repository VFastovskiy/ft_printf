...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/03 15:20:02 by kcharlet          #+#    #+#             */
/*   Updated: 2020/08/03 15:22:44 by kcharlet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

void	print_plusminhash_add2(t_print *printf)
{
	if (printf->itoa[0] == '-')
	{
...
void	print_plusminhash_add(t_print *printf, int i, int y)
{
...
void	print_flag_plusminushash(t_print *printf, int i, int y)
{
	...
	if ((int_zero_prec(printf, y, f)) == 0)
		...
		print_plusminhash_add(printf, i, y);
	else if (printf->width <= i + printf->precision)
		print_plusminhash_add2(printf);
}
